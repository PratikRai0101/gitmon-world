...
export default function TrainerCard({ username, avatarUrl, topLanguage, stars, onClose, online, linkedinUrl }: Props) {
  ...
  return (
    <AnimatePresence>
      <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.98 }} transition={{ duration: 0.18 }} className="trainer-card tw-trainer" style={{ width: 340 }}>
